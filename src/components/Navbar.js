    ...
    <Popover className="relative bg-transparent z-10">
      <div className="flex items-center justify-between  py-3 md:justify-start md:space-x-10 animate-top-left">
        ...
        <div className=" flex items-center justify-center md:flex md:flex-1 space-x-4 lg:w-0">
          ...
          <a
            href="/"
            className="mr-8 hidden  space-x-2 whitespace-nowrap  rounded-3xl py-3 px-[4.5rem] font-bold md:flex justify-center 
            items-center w-24 text-sm text-black  
            bg-gradient-to-b from-[#ACFFB9] to-[#11FF37]
             hover:from-[black] hover:to-[#000000a1] 
             transition-all duration-500 hover:text-white
             sm:flex md:mr-0 absolute right-0 font-monument"
          >
            BETA APP
          </a>
